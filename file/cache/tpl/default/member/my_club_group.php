...
<td class="tab" id="add"><a href="?mid=<?php echo $mid;?>&job=<?php echo $job;?>&action=add"><span>创建商圈</span></a></td>
<td class="tab" id="s3"><a href="?mid=<?php echo $mid;?>&job=<?php echo $job;?>"><span>已开通<span class="px10">(<?php echo $nums['3'];?>)</span></span></a></td>
<td class="tab" id="s2"><a href="?mid=<?php echo $mid;?>&job=<?php echo $job;?>&status=2"><span>审核中<span class="px10">(<?php echo $nums['2'];?>)</span></span></a></td>
<td class="tab" id="s1"><a href="?mid=<?php echo $mid;?>&job=<?php echo $job;?>&status=1"><span>未通过<span class="px10">(<?php echo $nums['1'];?>)</span></span></a></td>
</tr>
</table>
</div>
